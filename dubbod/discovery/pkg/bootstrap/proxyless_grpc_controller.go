...
func proxylessGRPCRuntimeConfigNeedsUpdate(req *discoverymodel.PushRequest) bool {
	...
	for cfg := range req.ConfigsUpdated {
		switch cfg.Kind {
		case kind.HTTPRoute, kind.PeerAuthentication, kind.RequestAuthentication, kind.AuthorizationPolicy, kind.Service, kind.EndpointSlice, kind.Endpoints, kind.Pod, kind.Namespace:
			return true
		}
	}
