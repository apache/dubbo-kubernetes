...
import (
	"github.com/apache/dubbo-kubernetes/dubbod/discovery/cmd/dubbo-agent/app"
...
func main() {
	rootCmd := app.NewRootCommand(
		func(options *security.Options, workloadSecretCache security.SecretManager) dubboagent.SDSService {
