...
var (
	serverArgs *bootstrap.PlanetArgs
)

func NewRootCommand() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:          "planet-discovery",
		Short:        "Dubbo Planet.",
		Long:         "Dubbo Planet provides mesh-wide traffic management, security and policy capabilities in the Dubbo Service Mesh.",
		SilenceUsage: true,
...
func addFlags(c *cobra.Command) {
	serverArgs = bootstrap.NewPlanetArgs(func(p *bootstrap.PlanetArgs) {
	...
	c.PersistentFlags().StringVar(&serverArgs.MeshGlobalConfigFile, "meshGlobalConfig", "./etc/dubbo/config/mesh",
