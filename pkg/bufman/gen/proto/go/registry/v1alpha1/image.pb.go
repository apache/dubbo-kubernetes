...
// 	protoc        (unknown)
// source: registry/v1alpha1/image.proto
...
func (ImageMask) Descriptor() protoreflect.EnumDescriptor {
	return file_registry_v1alpha1_image_proto_enumTypes[0].Descriptor()
}

func (ImageMask) Type() protoreflect.EnumType {
	return &file_registry_v1alpha1_image_proto_enumTypes[0]
}
...
func (ImageMask) EnumDescriptor() ([]byte, []int) {
	return file_registry_v1alpha1_image_proto_rawDescGZIP(), []int{0}
}
...
type GetImageRequest struct {
	...
	// message fields.
	IncludeMask []ImageMask `protobuf:"varint,7,rep,packed,name=include_mask,json=includeMask,proto3,enum=bufman.dubbo.apache.org.registry.v1alpha1.ImageMask" json:"include_mask,omitempty"`
}

func (x *GetImageRequest) Reset() {
	*x = GetImageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_registry_v1alpha1_image_proto_msgTypes[0]
...
func (x *GetImageResponse) Reset() {
	*x = GetImageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_registry_v1alpha1_image_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetImageResponse) Descriptor() ([]byte, []int) {
	return file_registry_v1alpha1_image_proto_rawDescGZIP(), []int{1}
}
...
var file_registry_v1alpha1_image_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x1a, 0x14, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0xad, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	0x22, 0x51, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x62, 0x75, 0x66, 0x6d, 0x61, 0x6e, 0x2e, 0x64, 0x75, 0x62,
	...
	,
	...
	0x65, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3b,
	...
	0x42, 0xe5, 0x02, 0x0a, 0x2d, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x6d, 0x61, 0x6e, 0x2e,
	0x64, 0x75, 0x62, 0x62, 0x6f, 0x2e, 0x61, 0x70, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x6f, 0x72, 0x67,
	0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x31, 0x42, 0x0a, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_registry_v1alpha1_image_proto_rawDescOnce sync.Once
	file_registry_v1alpha1_image_proto_rawDescData = file_registry_v1alpha1_image_proto_rawDesc
)

func file_registry_v1alpha1_image_proto_rawDescGZIP() []byte {
	file_registry_v1alpha1_image_proto_rawDescOnce.Do(func() {
		file_registry_v1alpha1_image_proto_rawDescData = protoimpl.X.CompressGZIP(file_registry_v1alpha1_image_proto_rawDescData)
	})
	return file_registry_v1alpha1_image_proto_rawDescData
}

var file_registry_v1alpha1_image_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_registry_v1alpha1_image_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_registry_v1alpha1_image_proto_goTypes = []interface{}{
	(ImageMask)(0),           // 0: bufman.dubbo.apache.org.registry.v1alpha1.ImageMask
	(*GetImageRequest)(nil),  // 1: bufman.dubbo.apache.org.registry.v1alpha1.GetImageRequest
	(*GetImageResponse)(nil), // 2: bufman.dubbo.apache.org.registry.v1alpha1.GetImageResponse
	(*v1.Image)(nil),         // 3: bufman.dubbo.apache.org.image.v1.Image
}
var file_registry_v1alpha1_image_proto_depIdxs = []int32{
	0, // 0: bufman.dubbo.apache.org.registry.v1alpha1.GetImageRequest.include_mask:type_name -> bufman.dubbo.apache.org.registry.v1alpha1.ImageMask
	3, // 1: bufman.dubbo.apache.org.registry.v1alpha1.GetImageResponse.image:type_name -> bufman.dubbo.apache.org.image.v1.Image
	1, // 2: bufman.dubbo.apache.org.registry.v1alpha1.ImageService.GetImage:input_type -> bufman.dubbo.apache.org.registry.v1alpha1.GetImageRequest
...
func init() { file_registry_v1alpha1_image_proto_init() }
func file_registry_v1alpha1_image_proto_init() {
	if File_registry_v1alpha1_image_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_registry_v1alpha1_image_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_registry_v1alpha1_image_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_registry_v1alpha1_image_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_registry_v1alpha1_image_proto_goTypes,
		DependencyIndexes: file_registry_v1alpha1_image_proto_depIdxs,
		EnumInfos:         file_registry_v1alpha1_image_proto_enumTypes,
		MessageInfos:      file_registry_v1alpha1_image_proto_msgTypes,
	}.Build()
	File_registry_v1alpha1_image_proto = out.File
	file_registry_v1alpha1_image_proto_rawDesc = nil
	file_registry_v1alpha1_image_proto_goTypes = nil
	file_registry_v1alpha1_image_proto_depIdxs = nil
}
