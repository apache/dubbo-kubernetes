...
const (
	...
	AuditServiceName = "bufman.dubbo.apache.org.audit.v1alpha1.AuditService"
)
...
const (
	...
	AuditServiceListAuditedEventsProcedure = "/bufman.dubbo.apache.org.audit.v1alpha1.AuditService/ListAuditedEvents"
)

// AuditServiceClient is a client for the bufman.dubbo.apache.org.audit.v1alpha1.AuditService
// service.
...
// bufman.dubbo.apache.org.audit.v1alpha1.AuditService service. By default, it uses the Connect
...
// ListAuditedEvents calls bufman.dubbo.apache.org.audit.v1alpha1.AuditService.ListAuditedEvents.
...
// bufman.dubbo.apache.org.audit.v1alpha1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.audit.v1alpha1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditedEvents(context.Context, *connect_go.Request[v1alpha1.ListAuditedEventsRequest]) (*connect_go.Response[v1alpha1.ListAuditedEventsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.audit.v1alpha1.AuditService.ListAuditedEvents is not implemented"))
}
