...
const (
	...
	TokenServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.TokenService"
)
...
const (
	...
	// RPC.
	TokenServiceCreateTokenProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.TokenService/CreateToken"
	// TokenServiceGetTokenProcedure is the fully-qualified name of the TokenService's GetToken RPC.
	TokenServiceGetTokenProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.TokenService/GetToken"
	// TokenServiceListTokensProcedure is the fully-qualified name of the TokenService's ListTokens RPC.
	TokenServiceListTokensProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.TokenService/ListTokens"
	// TokenServiceDeleteTokenProcedure is the fully-qualified name of the TokenService's DeleteToken
	// RPC.
	TokenServiceDeleteTokenProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.TokenService/DeleteToken"
)

// TokenServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.TokenService
// service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.TokenService service. By default, it uses the Connect
...
// CreateToken calls bufman.dubbo.apache.org.registry.v1alpha1.TokenService.CreateToken.
...
// GetToken calls bufman.dubbo.apache.org.registry.v1alpha1.TokenService.GetToken.
...
// ListTokens calls bufman.dubbo.apache.org.registry.v1alpha1.TokenService.ListTokens.
...
// DeleteToken calls bufman.dubbo.apache.org.registry.v1alpha1.TokenService.DeleteToken.
...
// bufman.dubbo.apache.org.registry.v1alpha1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.TokenService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokenServiceHandler) CreateToken(context.Context, *connect_go.Request[v1alpha1.CreateTokenRequest]) (*connect_go.Response[v1alpha1.CreateTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.TokenService.CreateToken is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) GetToken(context.Context, *connect_go.Request[v1alpha1.GetTokenRequest]) (*connect_go.Response[v1alpha1.GetTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.TokenService.GetToken is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) ListTokens(context.Context, *connect_go.Request[v1alpha1.ListTokensRequest]) (*connect_go.Response[v1alpha1.ListTokensResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.TokenService.ListTokens is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) DeleteToken(context.Context, *connect_go.Request[v1alpha1.DeleteTokenRequest]) (*connect_go.Response[v1alpha1.DeleteTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.TokenService.DeleteToken is not implemented"))
}
