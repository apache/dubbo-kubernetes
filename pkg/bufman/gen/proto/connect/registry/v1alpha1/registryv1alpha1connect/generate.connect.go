...
const (
	...
	GenerateServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.GenerateService"
)
...
const (
	...
	// GeneratePlugins RPC.
	GenerateServiceGeneratePluginsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.GenerateService/GeneratePlugins"
	// GenerateServiceGenerateTemplateProcedure is the fully-qualified name of the GenerateService's
	// GenerateTemplate RPC.
	GenerateServiceGenerateTemplateProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.GenerateService/GenerateTemplate"
)

// GenerateServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.GenerateService service.
...
// NewGenerateServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.GenerateService service. By default, it uses the
...
// GeneratePlugins calls bufman.dubbo.apache.org.registry.v1alpha1.GenerateService.GeneratePlugins.
...
// GenerateTemplate calls
// bufman.dubbo.apache.org.registry.v1alpha1.GenerateService.GenerateTemplate.
...
// GenerateServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.GenerateService service.
...
func NewGenerateServiceHandler(svc GenerateServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.GenerateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGenerateServiceHandler) GeneratePlugins(context.Context, *connect_go.Request[v1alpha1.GeneratePluginsRequest]) (*connect_go.Response[v1alpha1.GeneratePluginsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.GenerateService.GeneratePlugins is not implemented"))
}
...
func (UnimplementedGenerateServiceHandler) GenerateTemplate(context.Context, *connect_go.Request[v1alpha1.GenerateTemplateRequest]) (*connect_go.Response[v1alpha1.GenerateTemplateResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.GenerateService.GenerateTemplate is not implemented"))
}
