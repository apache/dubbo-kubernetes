...
const (
	...
	ResourceServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.ResourceService"
)
...
const (
	...
	ResourceServiceGetResourceByNameProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResourceService/GetResourceByName"
)

// ResourceServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.ResourceService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.ResourceService service. By default, it uses the
...
// GetResourceByName calls
// bufman.dubbo.apache.org.registry.v1alpha1.ResourceService.GetResourceByName.
...
func NewResourceServiceHandler(svc ResourceServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.ResourceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResourceServiceHandler) GetResourceByName(context.Context, *connect_go.Request[v1alpha1.GetResourceByNameRequest]) (*connect_go.Response[v1alpha1.GetResourceByNameResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResourceService.GetResourceByName is not implemented"))
}
