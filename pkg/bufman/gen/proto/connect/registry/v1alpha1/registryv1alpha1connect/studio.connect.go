...
const (
	...
	StudioServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.StudioService"
)
...
const (
	...
	StudioServiceListStudioAgentPresetsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.StudioService/ListStudioAgentPresets"
	// StudioServiceSetStudioAgentPresetsProcedure is the fully-qualified name of the StudioService's
	// SetStudioAgentPresets RPC.
	StudioServiceSetStudioAgentPresetsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.StudioService/SetStudioAgentPresets"
)

// StudioServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.StudioService
// service.
...
// NewStudioServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.StudioService service. By default, it uses the Connect
...
// ListStudioAgentPresets calls
// bufman.dubbo.apache.org.registry.v1alpha1.StudioService.ListStudioAgentPresets.
...
// SetStudioAgentPresets calls
// bufman.dubbo.apache.org.registry.v1alpha1.StudioService.SetStudioAgentPresets.
...
// StudioServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.StudioService service.
...
func NewStudioServiceHandler(svc StudioServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.StudioService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedStudioServiceHandler) ListStudioAgentPresets(context.Context, *connect_go.Request[v1alpha1.ListStudioAgentPresetsRequest]) (*connect_go.Response[v1alpha1.ListStudioAgentPresetsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.StudioService.ListStudioAgentPresets is not implemented"))
}
...
func (UnimplementedStudioServiceHandler) SetStudioAgentPresets(context.Context, *connect_go.Request[v1alpha1.SetStudioAgentPresetsRequest]) (*connect_go.Response[v1alpha1.SetStudioAgentPresetsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.StudioService.SetStudioAgentPresets is not implemented"))
}
