...
const (
	...
	ImageServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.ImageService"
)
...
const (
	...
	ImageServiceGetImageProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ImageService/GetImage"
)

// ImageServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.ImageService
// service.
...
// NewImageServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.ImageService service. By default, it uses the Connect
...
// GetImage calls bufman.dubbo.apache.org.registry.v1alpha1.ImageService.GetImage.
...
// ImageServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.ImageService service.
...
func NewImageServiceHandler(svc ImageServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.ImageService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedImageServiceHandler) GetImage(context.Context, *connect_go.Request[v1alpha1.GetImageRequest]) (*connect_go.Response[v1alpha1.GetImageResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ImageService.GetImage is not implemented"))
}
