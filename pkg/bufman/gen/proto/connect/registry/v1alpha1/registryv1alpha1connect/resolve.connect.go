...
const (
	...
	ResolveServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.ResolveService"
	// LocalResolveServiceName is the fully-qualified name of the LocalResolveService service.
	LocalResolveServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService"
)
...
const (
	...
	// GetModulePins RPC.
	ResolveServiceGetModulePinsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/GetModulePins"
	// ResolveServiceGetGoVersionProcedure is the fully-qualified name of the ResolveService's
	// GetGoVersion RPC.
	ResolveServiceGetGoVersionProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/GetGoVersion"
	// ResolveServiceGetSwiftVersionProcedure is the fully-qualified name of the ResolveService's
	// GetSwiftVersion RPC.
	ResolveServiceGetSwiftVersionProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/GetSwiftVersion"
	// ResolveServiceGetMavenVersionProcedure is the fully-qualified name of the ResolveService's
	// GetMavenVersion RPC.
	ResolveServiceGetMavenVersionProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/GetMavenVersion"
	// ResolveServiceGetNPMVersionProcedure is the fully-qualified name of the ResolveService's
	// GetNPMVersion RPC.
	ResolveServiceGetNPMVersionProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/GetNPMVersion"
	...
	LocalResolveServiceGetLocalModulePinsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService/GetLocalModulePins"
)

// ResolveServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.ResolveService
// service.
...
// NewResolveServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.ResolveService service. By default, it uses the Connect
...
// GetModulePins calls bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetModulePins.
...
// GetGoVersion calls bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetGoVersion.
...
// GetSwiftVersion calls bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetSwiftVersion.
...
// GetMavenVersion calls bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetMavenVersion.
...
// GetNPMVersion calls bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetNPMVersion.
...
// ResolveServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.ResolveService service.
...
func NewResolveServiceHandler(svc ResolveServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.ResolveService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResolveServiceHandler) GetModulePins(context.Context, *connect_go.Request[v1alpha1.GetModulePinsRequest]) (*connect_go.Response[v1alpha1.GetModulePinsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetModulePins is not implemented"))
}
...
func (UnimplementedResolveServiceHandler) GetGoVersion(context.Context, *connect_go.Request[v1alpha1.GetGoVersionRequest]) (*connect_go.Response[v1alpha1.GetGoVersionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetGoVersion is not implemented"))
}
...
func (UnimplementedResolveServiceHandler) GetSwiftVersion(context.Context, *connect_go.Request[v1alpha1.GetSwiftVersionRequest]) (*connect_go.Response[v1alpha1.GetSwiftVersionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetSwiftVersion is not implemented"))
}
...
func (UnimplementedResolveServiceHandler) GetMavenVersion(context.Context, *connect_go.Request[v1alpha1.GetMavenVersionRequest]) (*connect_go.Response[v1alpha1.GetMavenVersionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetMavenVersion is not implemented"))
}
...
func (UnimplementedResolveServiceHandler) GetNPMVersion(context.Context, *connect_go.Request[v1alpha1.GetNPMVersionRequest]) (*connect_go.Response[v1alpha1.GetNPMVersionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ResolveService.GetNPMVersion is not implemented"))
}

// LocalResolveServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService service. By default, it uses the
...
// GetLocalModulePins calls
// bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService.GetLocalModulePins.
...
func NewLocalResolveServiceHandler(svc LocalResolveServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLocalResolveServiceHandler) GetLocalModulePins(context.Context, *connect_go.Request[v1alpha1.GetLocalModulePinsRequest]) (*connect_go.Response[v1alpha1.GetLocalModulePinsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.LocalResolveService.GetLocalModulePins is not implemented"))
}
