...
const (
	...
	WebhookServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.WebhookService"
)
...
const (
	...
	// CreateWebhook RPC.
	WebhookServiceCreateWebhookProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.WebhookService/CreateWebhook"
	// WebhookServiceDeleteWebhookProcedure is the fully-qualified name of the WebhookService's
	// DeleteWebhook RPC.
	WebhookServiceDeleteWebhookProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.WebhookService/DeleteWebhook"
	// WebhookServiceListWebhooksProcedure is the fully-qualified name of the WebhookService's
	// ListWebhooks RPC.
	WebhookServiceListWebhooksProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.WebhookService/ListWebhooks"
)

// WebhookServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.WebhookService
// service.
...
// NewWebhookServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.WebhookService service. By default, it uses the Connect
...
// CreateWebhook calls bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.CreateWebhook.
...
// DeleteWebhook calls bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.DeleteWebhook.
...
// ListWebhooks calls bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.ListWebhooks.
...
// WebhookServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.WebhookService service.
...
func NewWebhookServiceHandler(svc WebhookServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.WebhookService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWebhookServiceHandler) CreateWebhook(context.Context, *connect_go.Request[v1alpha1.CreateWebhookRequest]) (*connect_go.Response[v1alpha1.CreateWebhookResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.CreateWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) DeleteWebhook(context.Context, *connect_go.Request[v1alpha1.DeleteWebhookRequest]) (*connect_go.Response[v1alpha1.DeleteWebhookResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.DeleteWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) ListWebhooks(context.Context, *connect_go.Request[v1alpha1.ListWebhooksRequest]) (*connect_go.Response[v1alpha1.ListWebhooksResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.WebhookService.ListWebhooks is not implemented"))
}
