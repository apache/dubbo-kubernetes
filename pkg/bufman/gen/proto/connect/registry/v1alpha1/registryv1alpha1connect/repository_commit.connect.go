...
const (
	...
	RepositoryCommitServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService"
)
...
const (
	...
	RepositoryCommitServiceListRepositoryCommitsByBranchProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/ListRepositoryCommitsByBranch"
	...
	RepositoryCommitServiceListRepositoryCommitsByReferenceProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/ListRepositoryCommitsByReference"
	...
	RepositoryCommitServiceGetRepositoryCommitByReferenceProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/GetRepositoryCommitByReference"
	...
	RepositoryCommitServiceGetRepositoryCommitBySequenceIdProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/GetRepositoryCommitBySequenceId"
	...
	RepositoryCommitServiceListRepositoryDraftCommitsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/ListRepositoryDraftCommits"
	...
	RepositoryCommitServiceDeleteRepositoryDraftCommitProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/DeleteRepositoryDraftCommit"
)

// RepositoryCommitServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService service. By default, it uses
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.ListRepositoryCommitsByReference.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.GetRepositoryCommitByReference.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.GetRepositoryCommitBySequenceId.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.ListRepositoryDraftCommits.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.DeleteRepositoryDraftCommit.
...
func NewRepositoryCommitServiceHandler(svc RepositoryCommitServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRepositoryCommitServiceHandler) ListRepositoryCommitsByBranch(context.Context, *connect_go.Request[v1alpha1.ListRepositoryCommitsByBranchRequest]) (*connect_go.Response[v1alpha1.ListRepositoryCommitsByBranchResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.ListRepositoryCommitsByBranch is not implemented"))
}
...
func (UnimplementedRepositoryCommitServiceHandler) ListRepositoryCommitsByReference(context.Context, *connect_go.Request[v1alpha1.ListRepositoryCommitsByReferenceRequest]) (*connect_go.Response[v1alpha1.ListRepositoryCommitsByReferenceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.ListRepositoryCommitsByReference is not implemented"))
}
...
func (UnimplementedRepositoryCommitServiceHandler) GetRepositoryCommitByReference(context.Context, *connect_go.Request[v1alpha1.GetRepositoryCommitByReferenceRequest]) (*connect_go.Response[v1alpha1.GetRepositoryCommitByReferenceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.GetRepositoryCommitByReference is not implemented"))
}
...
func (UnimplementedRepositoryCommitServiceHandler) GetRepositoryCommitBySequenceId(context.Context, *connect_go.Request[v1alpha1.GetRepositoryCommitBySequenceIdRequest]) (*connect_go.Response[v1alpha1.GetRepositoryCommitBySequenceIdResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.GetRepositoryCommitBySequenceId is not implemented"))
}
...
func (UnimplementedRepositoryCommitServiceHandler) ListRepositoryDraftCommits(context.Context, *connect_go.Request[v1alpha1.ListRepositoryDraftCommitsRequest]) (*connect_go.Response[v1alpha1.ListRepositoryDraftCommitsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.ListRepositoryDraftCommits is not implemented"))
}
...
func (UnimplementedRepositoryCommitServiceHandler) DeleteRepositoryDraftCommit(context.Context, *connect_go.Request[v1alpha1.DeleteRepositoryDraftCommitRequest]) (*connect_go.Response[v1alpha1.DeleteRepositoryDraftCommitResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryCommitService.DeleteRepositoryDraftCommit is not implemented"))
}
