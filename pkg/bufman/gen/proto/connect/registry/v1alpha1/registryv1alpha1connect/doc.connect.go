...
const (
	...
	DocServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.DocService"
)
...
const (
	...
	DocServiceGetSourceDirectoryInfoProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/GetSourceDirectoryInfo"
	// DocServiceGetSourceFileProcedure is the fully-qualified name of the DocService's GetSourceFile
	// RPC.
	DocServiceGetSourceFileProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/GetSourceFile"
	// DocServiceGetModulePackagesProcedure is the fully-qualified name of the DocService's
	// GetModulePackages RPC.
	DocServiceGetModulePackagesProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/GetModulePackages"
	// DocServiceGetModuleDocumentationProcedure is the fully-qualified name of the DocService's
	// GetModuleDocumentation RPC.
	DocServiceGetModuleDocumentationProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/GetModuleDocumentation"
	// DocServiceGetPackageDocumentationProcedure is the fully-qualified name of the DocService's
	// GetPackageDocumentation RPC.
	DocServiceGetPackageDocumentationProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/GetPackageDocumentation"
)

// DocServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.DocService
// service.
...
// NewDocServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.DocService service. By default, it uses the Connect
...
// GetSourceDirectoryInfo calls
// bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetSourceDirectoryInfo.
...
// GetSourceFile calls bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetSourceFile.
...
// GetModulePackages calls bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetModulePackages.
...
// GetModuleDocumentation calls
// bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetModuleDocumentation.
...
// GetPackageDocumentation calls
// bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetPackageDocumentation.
...
// DocServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.DocService service.
...
func NewDocServiceHandler(svc DocServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.DocService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDocServiceHandler) GetSourceDirectoryInfo(context.Context, *connect_go.Request[v1alpha1.GetSourceDirectoryInfoRequest]) (*connect_go.Response[v1alpha1.GetSourceDirectoryInfoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetSourceDirectoryInfo is not implemented"))
}
...
func (UnimplementedDocServiceHandler) GetSourceFile(context.Context, *connect_go.Request[v1alpha1.GetSourceFileRequest]) (*connect_go.Response[v1alpha1.GetSourceFileResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetSourceFile is not implemented"))
}
...
func (UnimplementedDocServiceHandler) GetModulePackages(context.Context, *connect_go.Request[v1alpha1.GetModulePackagesRequest]) (*connect_go.Response[v1alpha1.GetModulePackagesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetModulePackages is not implemented"))
}
...
func (UnimplementedDocServiceHandler) GetModuleDocumentation(context.Context, *connect_go.Request[v1alpha1.GetModuleDocumentationRequest]) (*connect_go.Response[v1alpha1.GetModuleDocumentationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetModuleDocumentation is not implemented"))
}
...
func (UnimplementedDocServiceHandler) GetPackageDocumentation(context.Context, *connect_go.Request[v1alpha1.GetPackageDocumentationRequest]) (*connect_go.Response[v1alpha1.GetPackageDocumentationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.DocService.GetPackageDocumentation is not implemented"))
}
