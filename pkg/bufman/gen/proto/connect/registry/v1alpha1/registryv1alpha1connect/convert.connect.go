...
const (
	...
	ConvertServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.ConvertService"
)
...
const (
	...
	ConvertServiceConvertProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ConvertService/Convert"
)

// ConvertServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.ConvertService
// service.
...
// NewConvertServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.ConvertService service. By default, it uses the Connect
...
// Convert calls bufman.dubbo.apache.org.registry.v1alpha1.ConvertService.Convert.
...
// ConvertServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.ConvertService service.
...
func NewConvertServiceHandler(svc ConvertServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.ConvertService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConvertServiceHandler) Convert(context.Context, *connect_go.Request[v1alpha1.ConvertRequest]) (*connect_go.Response[v1alpha1.ConvertResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ConvertService.Convert is not implemented"))
}
