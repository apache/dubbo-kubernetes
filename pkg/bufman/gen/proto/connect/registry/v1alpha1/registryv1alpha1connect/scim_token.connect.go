...
const (
	...
	SCIMTokenServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService"
)
...
const (
	...
	// CreateSCIMToken RPC.
	SCIMTokenServiceCreateSCIMTokenProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService/CreateSCIMToken"
	// SCIMTokenServiceListSCIMTokensProcedure is the fully-qualified name of the SCIMTokenService's
	// ListSCIMTokens RPC.
	SCIMTokenServiceListSCIMTokensProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService/ListSCIMTokens"
	// SCIMTokenServiceDeleteSCIMTokenProcedure is the fully-qualified name of the SCIMTokenService's
	// DeleteSCIMToken RPC.
	SCIMTokenServiceDeleteSCIMTokenProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService/DeleteSCIMToken"
)

// SCIMTokenServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService service. By default, it uses the
...
// CreateSCIMToken calls bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.CreateSCIMToken.
...
// ListSCIMTokens calls bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.ListSCIMTokens.
...
// DeleteSCIMToken calls bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.DeleteSCIMToken.
...
// SCIMTokenServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService service.
...
func NewSCIMTokenServiceHandler(svc SCIMTokenServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSCIMTokenServiceHandler) CreateSCIMToken(context.Context, *connect_go.Request[v1alpha1.CreateSCIMTokenRequest]) (*connect_go.Response[v1alpha1.CreateSCIMTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.CreateSCIMToken is not implemented"))
}
...
func (UnimplementedSCIMTokenServiceHandler) ListSCIMTokens(context.Context, *connect_go.Request[v1alpha1.ListSCIMTokensRequest]) (*connect_go.Response[v1alpha1.ListSCIMTokensResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.ListSCIMTokens is not implemented"))
}
...
func (UnimplementedSCIMTokenServiceHandler) DeleteSCIMToken(context.Context, *connect_go.Request[v1alpha1.DeleteSCIMTokenRequest]) (*connect_go.Response[v1alpha1.DeleteSCIMTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.SCIMTokenService.DeleteSCIMToken is not implemented"))
}
