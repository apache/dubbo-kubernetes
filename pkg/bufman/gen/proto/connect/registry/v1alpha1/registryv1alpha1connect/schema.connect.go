...
const (
	...
	SchemaServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.SchemaService"
)
...
const (
	...
	SchemaServiceGetSchemaProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.SchemaService/GetSchema"
	// SchemaServiceConvertMessageProcedure is the fully-qualified name of the SchemaService's
	// ConvertMessage RPC.
	SchemaServiceConvertMessageProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.SchemaService/ConvertMessage"
)

// SchemaServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.SchemaService
// service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.SchemaService service. By default, it uses the Connect
...
// ConvertMessage calls bufman.dubbo.apache.org.registry.v1alpha1.SchemaService.ConvertMessage.
...
// bufman.dubbo.apache.org.registry.v1alpha1.SchemaService service.
...
func NewSchemaServiceHandler(svc SchemaServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.SchemaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSchemaServiceHandler) GetSchema(context.Context, *connect_go.Request[v1alpha1.GetSchemaRequest]) (*connect_go.Response[v1alpha1.GetSchemaResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.SchemaService.GetSchema is not implemented"))
}
...
func (UnimplementedSchemaServiceHandler) ConvertMessage(context.Context, *connect_go.Request[v1alpha1.ConvertMessageRequest]) (*connect_go.Response[v1alpha1.ConvertMessageResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.SchemaService.ConvertMessage is not implemented"))
}
