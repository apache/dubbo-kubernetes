...
const (
	...
	RepositoryTagServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService"
)
...
const (
	...
	RepositoryTagServiceCreateRepositoryTagProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService/CreateRepositoryTag"
	...
	RepositoryTagServiceListRepositoryTagsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService/ListRepositoryTags"
	...
	RepositoryTagServiceListRepositoryTagsForReferenceProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService/ListRepositoryTagsForReference"
)

// RepositoryTagServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService service. By default, it uses the
...
// CreateRepositoryTag calls
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService.CreateRepositoryTag.
...
// bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService.ListRepositoryTagsForReference.
...
func NewRepositoryTagServiceHandler(svc RepositoryTagServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRepositoryTagServiceHandler) CreateRepositoryTag(context.Context, *connect_go.Request[v1alpha1.CreateRepositoryTagRequest]) (*connect_go.Response[v1alpha1.CreateRepositoryTagResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService.CreateRepositoryTag is not implemented"))
}
...
func (UnimplementedRepositoryTagServiceHandler) ListRepositoryTags(context.Context, *connect_go.Request[v1alpha1.ListRepositoryTagsRequest]) (*connect_go.Response[v1alpha1.ListRepositoryTagsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService.ListRepositoryTags is not implemented"))
}
...
func (UnimplementedRepositoryTagServiceHandler) ListRepositoryTagsForReference(context.Context, *connect_go.Request[v1alpha1.ListRepositoryTagsForReferenceRequest]) (*connect_go.Response[v1alpha1.ListRepositoryTagsForReferenceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.RepositoryTagService.ListRepositoryTagsForReference is not implemented"))
}
