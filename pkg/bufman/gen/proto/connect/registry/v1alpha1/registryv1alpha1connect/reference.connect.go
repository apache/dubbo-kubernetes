...
const (
	...
	ReferenceServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService"
)
...
const (
	...
	ReferenceServiceGetReferenceByNameProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService/GetReferenceByName"
	...
	ReferenceServiceListGitCommitMetadataForReferenceProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService/ListGitCommitMetadataForReference"
)

// ReferenceServiceClient is a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService service.
...
// bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService service. By default, it uses the
...
// GetReferenceByName calls
// bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService.GetReferenceByName.
...
// bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService.ListGitCommitMetadataForReference.
...
// ReferenceServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService service.
...
func NewReferenceServiceHandler(svc ReferenceServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedReferenceServiceHandler) GetReferenceByName(context.Context, *connect_go.Request[v1alpha1.GetReferenceByNameRequest]) (*connect_go.Response[v1alpha1.GetReferenceByNameResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService.GetReferenceByName is not implemented"))
}
...
func (UnimplementedReferenceServiceHandler) ListGitCommitMetadataForReference(context.Context, *connect_go.Request[v1alpha1.ListGitCommitMetadataForReferenceRequest]) (*connect_go.Response[v1alpha1.ListGitCommitMetadataForReferenceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.ReferenceService.ListGitCommitMetadataForReference is not implemented"))
}
