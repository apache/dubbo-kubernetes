...
const (
	...
	AuthnServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.AuthnService"
)
...
const (
	...
	// GetCurrentUser RPC.
	AuthnServiceGetCurrentUserProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AuthnService/GetCurrentUser"
	// AuthnServiceGetCurrentUserSubjectProcedure is the fully-qualified name of the AuthnService's
	// GetCurrentUserSubject RPC.
	AuthnServiceGetCurrentUserSubjectProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AuthnService/GetCurrentUserSubject"
)

// AuthnServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.AuthnService
// service.
...
// NewAuthnServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.AuthnService service. By default, it uses the Connect
...
// GetCurrentUser calls bufman.dubbo.apache.org.registry.v1alpha1.AuthnService.GetCurrentUser.
...
// GetCurrentUserSubject calls
// bufman.dubbo.apache.org.registry.v1alpha1.AuthnService.GetCurrentUserSubject.
...
// AuthnServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.AuthnService service.
...
func NewAuthnServiceHandler(svc AuthnServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.AuthnService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthnServiceHandler) GetCurrentUser(context.Context, *connect_go.Request[v1alpha1.GetCurrentUserRequest]) (*connect_go.Response[v1alpha1.GetCurrentUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AuthnService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedAuthnServiceHandler) GetCurrentUserSubject(context.Context, *connect_go.Request[v1alpha1.GetCurrentUserSubjectRequest]) (*connect_go.Response[v1alpha1.GetCurrentUserSubjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AuthnService.GetCurrentUserSubject is not implemented"))
}
