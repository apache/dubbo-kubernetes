...
const (
	...
	AdminServiceName = "bufman.dubbo.apache.org.registry.v1alpha1.AdminService"
)
...
const (
	...
	// ForceDeleteUser RPC.
	AdminServiceForceDeleteUserProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/ForceDeleteUser"
	...
	AdminServiceUpdateUserVerificationStatusProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/UpdateUserVerificationStatus"
	...
	AdminServiceUpdateOrganizationVerificationStatusProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/UpdateOrganizationVerificationStatus"
	// AdminServiceCreateMachineUserProcedure is the fully-qualified name of the AdminService's
	// CreateMachineUser RPC.
	AdminServiceCreateMachineUserProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/CreateMachineUser"
	...
	AdminServiceGetBreakingChangePolicyProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/GetBreakingChangePolicy"
	...
	AdminServiceUpdateBreakingChangePolicyProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/UpdateBreakingChangePolicy"
	// AdminServiceGetUniquenessPolicyProcedure is the fully-qualified name of the AdminService's
	// GetUniquenessPolicy RPC.
	AdminServiceGetUniquenessPolicyProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/GetUniquenessPolicy"
	// AdminServiceUpdateUniquenessPolicyProcedure is the fully-qualified name of the AdminService's
	// UpdateUniquenessPolicy RPC.
	AdminServiceUpdateUniquenessPolicyProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/UpdateUniquenessPolicy"
	...
	AdminServiceListServerUniquenessCollisionsProcedure = "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/ListServerUniquenessCollisions"
)

// AdminServiceClient is a client for the bufman.dubbo.apache.org.registry.v1alpha1.AdminService
// service.
...
// NewAdminServiceClient constructs a client for the
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService service. By default, it uses the Connect
...
// ForceDeleteUser calls bufman.dubbo.apache.org.registry.v1alpha1.AdminService.ForceDeleteUser.
...
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateUserVerificationStatus.
...
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateOrganizationVerificationStatus.
...
// CreateMachineUser calls bufman.dubbo.apache.org.registry.v1alpha1.AdminService.CreateMachineUser.
...
// GetBreakingChangePolicy calls
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.GetBreakingChangePolicy.
...
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateBreakingChangePolicy.
...
// GetUniquenessPolicy calls
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.GetUniquenessPolicy.
...
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService.ListServerUniquenessCollisions.
...
// AdminServiceHandler is an implementation of the
// bufman.dubbo.apache.org.registry.v1alpha1.AdminService service.
...
func NewAdminServiceHandler(svc AdminServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.dubbo.apache.org.registry.v1alpha1.AdminService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAdminServiceHandler) ForceDeleteUser(context.Context, *connect_go.Request[v1alpha1.ForceDeleteUserRequest]) (*connect_go.Response[v1alpha1.ForceDeleteUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.ForceDeleteUser is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) UpdateUserVerificationStatus(context.Context, *connect_go.Request[v1alpha1.UpdateUserVerificationStatusRequest]) (*connect_go.Response[v1alpha1.UpdateUserVerificationStatusResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateUserVerificationStatus is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) UpdateOrganizationVerificationStatus(context.Context, *connect_go.Request[v1alpha1.UpdateOrganizationVerificationStatusRequest]) (*connect_go.Response[v1alpha1.UpdateOrganizationVerificationStatusResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateOrganizationVerificationStatus is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) CreateMachineUser(context.Context, *connect_go.Request[v1alpha1.CreateMachineUserRequest]) (*connect_go.Response[v1alpha1.CreateMachineUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.CreateMachineUser is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) GetBreakingChangePolicy(context.Context, *connect_go.Request[v1alpha1.GetBreakingChangePolicyRequest]) (*connect_go.Response[v1alpha1.GetBreakingChangePolicyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.GetBreakingChangePolicy is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) UpdateBreakingChangePolicy(context.Context, *connect_go.Request[v1alpha1.UpdateBreakingChangePolicyRequest]) (*connect_go.Response[v1alpha1.UpdateBreakingChangePolicyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateBreakingChangePolicy is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) GetUniquenessPolicy(context.Context, *connect_go.Request[v1alpha1.GetUniquenessPolicyRequest]) (*connect_go.Response[v1alpha1.GetUniquenessPolicyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.GetUniquenessPolicy is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) UpdateUniquenessPolicy(context.Context, *connect_go.Request[v1alpha1.UpdateUniquenessPolicyRequest]) (*connect_go.Response[v1alpha1.UpdateUniquenessPolicyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.UpdateUniquenessPolicy is not implemented"))
}
...
func (UnimplementedAdminServiceHandler) ListServerUniquenessCollisions(context.Context, *connect_go.Request[v1alpha1.ListServerUniquenessCollisionsRequest]) (*connect_go.Response[v1alpha1.ListServerUniquenessCollisionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.dubbo.apache.org.registry.v1alpha1.AdminService.ListServerUniquenessCollisions is not implemented"))
}
