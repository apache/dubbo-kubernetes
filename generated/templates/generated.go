...
// relative path from /app/dubboctl/internal/dubbo/templates_embedded.go to the project root (/)
 ...
 */`)
	...
	_, err = fmt.Fprint(srcOut, "// Code generated by go generate; DO NOT EDIT.\npackage generate\n\nvar TemplatesZip = []byte{")
	if err != nil {
		log.Fatal(err)
	}
