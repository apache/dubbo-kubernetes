...
var file_api_mesh_v1alpha1_metadata_proto_rawDesc = []byte{
	...
	0x02, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x7a,
	...
	0x70, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x3a, 0x73, 0xaa, 0x8c, 0x89, 0xa6, 0x01, 0x12, 0x0a, 0x10, 0x4d,
	...
	0x04, 0x52, 0x02, 0x08, 0x01, 0xaa, 0x8c, 0x89, 0xa6, 0x01, 0x0c, 0x3a, 0x0a, 0x0a, 0x08, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xaa, 0x8c, 0x89, 0xa6, 0x01, 0x02, 0x58, 0x01, 0xaa,
	...
	0x02, 0x38, 0x01, 0x32, 0x82, 0x01, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
...
var file_api_mesh_v1alpha1_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_mesh_v1alpha1_metadata_proto_goTypes = []interface{}{
	...
	(*MetaData)(nil),                 // 2: dubbo.mesh.v1alpha1.MetaData
	(*ServiceInfo)(nil),              // 3: dubbo.mesh.v1alpha1.ServiceInfo
	nil,                              // 4: dubbo.mesh.v1alpha1.MetaData.ServicesEntry
	nil,                              // 5: dubbo.mesh.v1alpha1.ServiceInfo.ParamsEntry
}
var file_api_mesh_v1alpha1_metadata_proto_depIdxs = []int32{
	2, // 0: dubbo.mesh.v1alpha1.MetaDataRegisterRequest.metadata:type_name -> dubbo.mesh.v1alpha1.MetaData
	4, // 1: dubbo.mesh.v1alpha1.MetaData.services:type_name -> dubbo.mesh.v1alpha1.MetaData.ServicesEntry
	5, // 2: dubbo.mesh.v1alpha1.ServiceInfo.params:type_name -> dubbo.mesh.v1alpha1.ServiceInfo.ParamsEntry
	3, // 3: dubbo.mesh.v1alpha1.MetaData.ServicesEntry.value:type_name -> dubbo.mesh.v1alpha1.ServiceInfo
	0, // 4: dubbo.mesh.v1alpha1.MetadataService.MetadataRegister:input_type -> dubbo.mesh.v1alpha1.MetaDataRegisterRequest
	1, // 5: dubbo.mesh.v1alpha1.MetadataService.MetadataRegister:output_type -> dubbo.mesh.v1alpha1.MetaDataRegisterResponse
