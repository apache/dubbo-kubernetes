...
var file_api_mesh_v1alpha1_dds_proto_rawDesc = []byte{
	...
	0x91, 0x03, 0x0a, 0x0e, 0x44, 0x44, 0x53, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x12, 0x80, 0x01, 0x0a, 0x13, 0x5a, 0x6f, 0x6e, 0x65, 0x54, 0x6f, 0x44, 0x75, 0x62, 0x62, 0x6f,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x32, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
...
var file_api_mesh_v1alpha1_dds_proto_depIdxs = []int32{
	...
	8, // 7: dubbo.mesh.v1alpha1.DDSSyncService.ZoneToDubboInstance:input_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
	2, // 8: dubbo.mesh.v1alpha1.GlobalDDSService.HealthCheck:output_type -> dubbo.mesh.v1alpha1.ZoneHealthCheckResponse
	8, // 9: dubbo.mesh.v1alpha1.DDSSyncService.GlobalToZoneSync:output_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
	7, // 10: dubbo.mesh.v1alpha1.DDSSyncService.ZoneToGlobalSync:output_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
	7, // 11: dubbo.mesh.v1alpha1.DDSSyncService.ZoneToDubboInstance:output_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
