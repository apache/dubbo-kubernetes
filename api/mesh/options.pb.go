...
type DubboResourceOptions struct {
	...
	Kds              *DubboKdsOptions `protobuf:"bytes,10,opt,name=kds,proto3" json:"kds,omitempty"`
...
func (x *DubboResourceOptions) GetKds() *DubboKdsOptions {
	if x != nil {
		return x.Kds
	}
	return nil
...
func (x *DubboKdsOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DubboKdsOptions) ProtoMessage() {}

func (x *DubboKdsOptions) ProtoReflect() protoreflect.Message {
	mi := &file_api_mesh_options_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DubboKdsOptions.ProtoReflect.Descriptor instead.
func (*DubboKdsOptions) Descriptor() ([]byte, []int) {
	return file_api_mesh_options_proto_rawDescGZIP(), []int{2}
}

func (x *DubboKdsOptions) GetSendToGlobal() bool {
	if x != nil {
...
func (x *DubboKdsOptions) GetSendToZone() bool {
	if x != nil {
		return x.SendToZone
	}
	return false
...
var file_api_mesh_options_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x03, 0x6b, 0x64, 0x73, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x64, 0x75, 0x62, 0x62, 0x6f, 0x2e, 0x6d, 0x65, 0x73, 0x68,
	0x2e, 0x44, 0x75, 0x62, 0x62, 0x6f, 0x4b, 0x64, 0x73, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x52, 0x03, 0x6b, 0x64, 0x73, 0x12, 0x2a, 0x0a, 0x02, 0x77, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x75, 0x62, 0x62, 0x6f, 0x4b, 0x64, 0x73, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x24,
...
var file_api_mesh_options_proto_goTypes = []interface{}{
	...
	(*DubboKdsOptions)(nil),             // 2: dubbo.mesh.DubboKdsOptions
...
var file_api_mesh_options_proto_depIdxs = []int32{
	2, // 0: dubbo.mesh.DubboResourceOptions.kds:type_name -> dubbo.mesh.DubboKdsOptions
