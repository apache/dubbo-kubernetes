...
type ObjectMetaApplyConfiguration struct {
	...
	OwnerReferences            []metav1.OwnerReferenceApplyConfiguration `json:"ownerReferences,omitempty"`
...
func (b *ObjectMetaApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ObjectMetaApplyConfiguration {
	for i := range values {
		if values[i] == nil {
