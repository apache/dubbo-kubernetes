...
URL="https://github.com/apache/dubbo-kubernetes/releases/download/${DUBBO_VERSION}/dubboctl-${DUBBO_VERSION}-${OSEXT}.tar.gz"
ARCH_URL="https://github.com/apache/dubbo-kubernetes/releases/download/${DUBBO_VERSION}/dubboctl-${DUBBO_VERSION}-${OSEXT}-${DUBBO_ARCH}.tar.gz"
